...
const MobileMenu = ({ links }: MobileMenuProps) => {
    ...
    const menuClasses = `bg-pale-green text-2xl font-bold p-4 fixed inset-0 w-[100vw] h-[100dvh] z-30 overscroll-contain flex justify-between  ${isOpen ? 'block overlay-open' : 'hidden'}`;
